...
namespace Practico2
{
    public partial class Form1 : Form
    {
        ...
        {
            // Utiliza la expresión regular para verificar si el carácter es un número
        ...
        {
            DialogResult ask = MessageBox.Show("Esta apunto de eliminar el cliente: " + TNombre.Text + " " + TApellido.Text, "Confirmar Eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2);
        ...
        private void radioButtonVaron_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                pictureBox1.Image = Properties.Resources.varon200x200;
            }
            else
            {
                pictureBox1.Image = Properties.Resources.mujer200x200;
            }
        }
    }
}
